...
var accordeonButton = document.querySelector('.footer-menu__accordeon-button');
var footerList = document.querySelector('.footer-menu__list');
var plusButton = document.querySelector('.footer-menu__accordeon-plus');
var minusButton = document.querySelector('.footer-menu__accordeon-minus');
var accordeonButtonContacts = document.querySelector('.footer-contacts__accordeon-button');
var contactsList = document.querySelector('.footer-contacts__list');
var plusButtonContacts = document.querySelector('.footer-contacts__accordeon-plus');
var minusButtonContacts = document.querySelector('.footer-contacts__accordeon-minus');
var aboutButton = document.querySelector('.about__button');
var aboutText = document.querySelector('.modal-form__close');
...
var closeModal = document.querySelector('.modal-form__close');
var modalWindow = document.querySelector('.modal-form');
var headerCallBack = document.querySelector('.header__calback');
var modalWrapper = document.querySelector('.modal-form__wrapper');
var feedbackForm = document.querySelector('.feedback-form');
var feedbackName = document.querySelector('.feedback-form__name');
...
var selector = document.querySelector('.feedback-form__phone');
var im = new Inputmask('+7 (999) 999-99-99');
im.mask(selector);

// Маска телефона для модального окна

var selectorModal = document.querySelector('.modal-form__phone');
var imModal = new Inputmask('+7 (999) 999-99-99');
imModal.mask(selectorModal);

// Валидация формы

var validation = new JustValidate('#feedback-form');
...
var validationModal = new JustValidate('#modal-form');
validationModal.addField('#modal-form__name', [{
  rule: 'minLength',
  value: 3,
  errorMessage: 'В имени должно быть больше трёх букв'
}, {
...
accordeonButtonContacts.addEventListener('click', function () {
